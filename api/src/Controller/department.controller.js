...
class DepartmentController {
    ...
    try{
        const departments = await db.query('INSERT INTO departments (id_organization, parent, name, comment) values ($1, $2, $3, $4) RETURNING *', [id_organization, parent, name, comment])
